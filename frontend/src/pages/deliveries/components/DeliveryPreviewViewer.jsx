    ...
    <Dialog open={open} onClose={onClose} fullWidth maxWidth="lg">
      <DialogTitle>
        <Stack direction="row" spacing={1} sx={{ alignItems: 'center', justifyContent: 'space-between' }}>
          <Typography fontWeight={900}>{file?.fileName || '交付作品'}</Typography>
      ...
      <DialogContent dividers sx={{ bgcolor: '#121821', p: 0, minHeight: '62vh', display: 'grid', placeItems: 'center', position: 'relative' }}>
        ...
        {previewUrl ? (
          <Box component="img" src={previewUrl} alt={file?.fileName || '交付作品'} sx={{ maxWidth: '100%', maxHeight: '74vh', objectFit: 'contain', display: 'block' }} />
        ) : (
